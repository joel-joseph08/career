...
if (isset($_POST['Send-Application'])) {
  ...
  $name = $_POST['name'];
  $link = $_POST['link'];
  $query = mysqli_query($conn, "INSERT INTO `tbl_apply`(`email`, `name`, `link`, `status`) VALUES ('$email','$name','$link','active')");
  if ($query) {
...
<head>
  <title>Smart Career &mdash; Website Template by Colorlib</title>
  <meta charset="utf-8">
    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="index.html">Smart career</a></div>
          ...
          <div class="col-lg-12">
            <form class="p-4 p-md-5 border rounded" method="post" action="">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="job-title" placeholder="">
              </div>
              <!-- <div class="form-group">
        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-4 ml-auto">
            <div class="row">
              ...
              <div class="col-6">
                <input type="submit" name="Send-Application" value="Send Application" class="btn btn-block btn-primary btn-md">
              </div>
            </div>
          </div>
          </form>
        ...
        <div class="row text-center">
          <div class="col-12">
            <p class="copyright"><small>
                ...
                </script> <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"></a>
